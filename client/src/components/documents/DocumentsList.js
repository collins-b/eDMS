  ...
  render() {
    const editActions = [
      ...
      <FlatButton
        ...
        onTouchTap={this.handleClose}
        // onClick={this.props.updateDocument(edit, 'title','content')}
    ...
    return(
      ...
      <Gravatar email={this.props.document.owner} style={{ float: 'left' }} size={50} rating="pg" default="identicon" className="CustomAvatar-image" />
        ...
        <CardText expandable={true}>
          {this.state.document.content}
           {/*<p><button className="btn btn-success btn-sm" onTouchTap={this.handleOpen}><i className="fa fa-edit" /></button> <button className="btn btn-danger btn-sm"><i className="fa fa-trash" /></button></p>*/}
      ...
      <Dialog
        ...
        <SelectField
          ...
          value={this.props.document.role}
